...
const mockVacancyFeed = [
  ...
  },
  {
    ...
    desc: "Help us build and maintain CI/CD pipelines on AWS and Azure.",
...
/* ── FORM SECTIONS ── */
.form-section { padding: 1rem 1.4rem; border-bottom: 1px solid rgba(255,255,255,0.4); }
.form-section-title { font-size: 0.67rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--indigo); opacity: 0.7; margin-bottom: 0.65rem; }
...
.knowmore-btn { display: flex; align-items: center; gap: 0.4rem; background: none; border: none; font-family: 'DM Sans', sans-serif; font-size: 0.82rem; font-weight: 600; color: var(--indigo); cursor: pointer; transition: 0.2s; }
.knowmore-btn:hover { opacity: 0.65; }
.details-box { margin-top: 0.75rem; background: rgba(255,255,255,0.6); border: 1px solid var(--border-strong); border-radius: var(--radius-sm); overflow: hidden; }
.details-row { display: flex; align-items: center; gap: 0.6rem; padding: 0.55rem 0.9rem; border-bottom: 1px solid rgba(255,255,255,0.5); font-size: 0.8rem; color: var(--slate); font-weight: 500; }
.details-row:last-child { border-bottom: none; }
.details-section-head { padding: 0.4rem 0.9rem; background: rgba(79,70,229,0.06); font-size: 0.66rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: var(--indigo); border-bottom: 1px solid rgba(255,255,255,0.5); }

/* ── FEEDS ── */
.feed-section { padding: 1rem 1.4rem; }
.feed-title { font-size: 0.67rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--indigo); opacity: 0.7; margin-bottom: 0.75rem; }
.posts-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 6px; }
.post-cell { aspect-ratio: 1; border-radius: 9px; overflow: hidden; position: relative; background: var(--border); border: 1px solid rgba(255,255,255,0.5); }
.post-cell img, .post-cell video { width: 100%; height: 100%; object-fit: cover; }
.post-del { position: absolute; top: 4px; right: 4px; width: 20px; height: 20px; border-radius: 5px; background: rgba(255,255,255,0.92); border: none; color: var(--rose); font-size: 0.58rem; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: 0.15s; }
...
/* ── RESUME ITEM ── */
.resume-item { display: flex; align-items: center; gap: 0.65rem; padding: 0.6rem 0.85rem; border-radius: var(--radius-sm); background: rgba(79,70,229,0.05); border: 1px solid rgba(79,70,229,0.12); margin-bottom: 0.5rem; }
...
.sec-link { font-size: 0.78rem; font-weight: 700; color: var(--indigo); background: none; border: none; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: 0.2s; }
.sec-link:hover { opacity: 0.65; }

/* ── JOB CARDS ── */
.jobs-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 1.1rem; }
.job-card { background: var(--surface-strong); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; cursor: pointer; box-shadow: var(--shadow-sm); transition: 0.25s; }
...
.badge { display: inline-flex; align-items: center; padding: 0.16rem 0.55rem; border-radius: 99px; font-size: 0.66rem; font-weight: 700; border: 1.5px solid; }
.job-salary { font-size: 0.76rem; color: var(--emerald); font-weight: 700; margin-bottom: 0.7rem; }
.apply-btn { width: 100%; padding: 0.5rem; border-radius: 99px; border: none; background: var(--grad); color: white; font-family: 'Syne', sans-serif; font-size: 0.78rem; font-weight: 700; cursor: pointer; box-shadow: 0 4px 12px rgba(79,70,229,0.22); transition: 0.2s; }
.apply-btn:hover { opacity: 0.88; transform: translateY(-1px); }

/* ── INDUSTRY FEED ── */
.feed-grid { display: flex; flex-direction: column; gap: 1.25rem; }
.feed-card { background: var(--surface-strong); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; cursor: pointer; box-shadow: var(--shadow-sm); transition: 0.25s; }
...
.feed-logo { width: 42px; height: 42px; border-radius: 11px; background: rgba(79,70,229,0.1); color: var(--indigo); font-family: 'Syne', sans-serif; font-weight: 800; font-size: 0.85rem; display: flex; align-items: center; justify-content: center; border: 1px solid rgba(79,70,229,0.15); }
.feed-owner-name { font-weight: 700; font-size: 0.95rem; }
.feed-date { font-size: 0.72rem; color: var(--subtle); }
.type-chip { padding: 0.2rem 0.65rem; border-radius: 99px; font-size: 0.68rem; font-weight: 700; }
...
.app-card { background: var(--surface-strong); border: 1px solid var(--border); border-radius: var(--radius); padding: 1.2rem; box-shadow: var(--shadow-sm); }
...
.course-card { background: var(--surface-strong); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; cursor: pointer; box-shadow: var(--shadow-sm); transition: 0.25s; }
...
.level-chip { position: absolute; top: 7px; right: 7px; padding: 0.16rem 0.5rem; border-radius: 99px; font-size: 0.62rem; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; border: 1.5px solid; }
.course-body { padding: 0.9rem; }
.course-prov { font-size: 0.67rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.07em; background: var(--grad); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 0.28rem; }
...
.enroll-btn { padding: 0.35rem 0.82rem; border-radius: 99px; background: var(--grad); color: white; font-family: 'Syne', sans-serif; font-size: 0.7rem; font-weight: 700; border: none; cursor: pointer; box-shadow: 0 3px 8px rgba(79,70,229,0.25); transition: 0.2s; }
.enroll-btn:hover { opacity: 0.85; transform: scale(1.05); }
.no-courses { background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius); padding: 2.5rem; text-align: center; color: var(--muted); font-size: 0.875rem; }

/* ── DM PANEL ── */
.dm-panel { width: 340px; min-width: 340px; background: var(--surface); backdrop-filter: blur(24px); border-left: 1px solid var(--border); height: calc(100vh - 62px); position: sticky; top: 62px; display: flex; flex-direction: column; flex-shrink: 0; }
.dm-head { padding: 1.2rem 1.4rem; border-bottom: 1px solid var(--border); display: flex; align-items: center; justify-content: space-between; background: var(--grad); }
...
.bubble { max-width: 74%; padding: 0.62rem 0.9rem; border-radius: 14px; font-size: 0.82rem; line-height: 1.45; }
...
.dm-foot { padding: 0.9rem; border-top: 1px solid var(--border); display: flex; gap: 0.55rem; background: rgba(255,255,255,0.4); }
.dm-input { flex: 1; padding: 0.6rem 0.9rem; border-radius: 99px; border: 1px solid var(--border-strong); background: var(--surface-strong); font-family: 'DM Sans', sans-serif; font-size: 0.82rem; color: var(--slate); outline: none; transition: 0.2s; }
.dm-input:focus { border-color: var(--indigo); box-shadow: 0 0 0 3px rgba(79,70,229,0.1); }
.dm-input::placeholder { color: var(--subtle); }
.send-btn { width: 40px; height: 40px; border-radius: 50%; background: var(--grad); border: none; color: white; font-size: 0.85rem; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(79,70,229,0.28); transition: 0.2s; }
.send-btn:hover { opacity: 0.85; transform: scale(1.07); }

/* ── MODALS ── */
.modal-overlay { position: fixed; inset: 0; background: rgba(15,23,42,0.65); backdrop-filter: blur(10px); display: flex; align-items: center; justify-content: center; z-index: 1000; }
.modal-box { background: white; border-radius: 22px; padding: 2.2rem; width: 100%; max-width: 580px; max-height: 88vh; overflow-y: auto; position: relative; box-shadow: 0 25px 60px rgba(15,23,42,0.4); }
.modal-close { position: absolute; top: 18px; right: 18px; width: 34px; height: 34px; border-radius: 50%; background: #f1f5f9; border: none; cursor: pointer; font-weight: 700; color: var(--muted); display: flex; align-items: center; justify-content: center; transition: 0.15s; }
...
.field-input { width: 100%; padding: 0.75rem 1rem; border-radius: 11px; border: 1.5px solid rgba(148,163,184,0.3); background: #f8fafc; font-family: 'DM Sans', sans-serif; font-size: 0.88rem; color: var(--slate); outline: none; transition: 0.2s; margin-bottom: 1rem; }
...
.btn-primary { width: 100%; padding: 0.9rem; border-radius: 12px; border: none; background: var(--grad); color: white; font-family: 'Syne', sans-serif; font-size: 0.95rem; font-weight: 700; cursor: pointer; box-shadow: 0 4px 16px rgba(79,70,229,0.3); transition: 0.2s; }
.btn-primary:hover { opacity: 0.9; transform: translateY(-1px); }
.btn-secondary { width: 100%; padding: 0.75rem; border-radius: 12px; margin-top: 0.6rem; border: 1.5px solid rgba(148,163,184,0.3); background: transparent; color: var(--muted); font-family: 'DM Sans', sans-serif; font-size: 0.88rem; font-weight: 600; cursor: pointer; transition: 0.2s; }
.btn-secondary:hover { background: #f1f5f9; }

/* ── LOADING ── */
.loading-spinner {
  display: flex; flex-direction: column; align-items: center; justify-content: center;
  padding: 3rem; gap: 1rem; color: var(--muted);
}
.spinner {
  width: 36px; height: 36px; border: 3px solid rgba(79,70,229,0.15);
...
/* ── NOTIFICATIONS ── */
.notif-toast { background: var(--navy); color: white; padding: 1rem 1.8rem; border-radius: 16px; box-shadow: 0 12px 32px rgba(15,23,42,0.3); font-size: 0.88rem; font-weight: 600; display: flex; align-items: center; gap: 10px; border: 1px solid rgba(255,255,255,0.08); }
.notif-dot2 { width: 8px; height: 8px; background: var(--indigo-light); border-radius: 50%; flex-shrink: 0; }

/* ── INBOX ── */
.inbox-banner { background: linear-gradient(135deg, rgba(79,70,229,0.07), rgba(124,58,237,0.05)); border: 1px solid rgba(79,70,229,0.18); border-radius: var(--radius); padding: 1rem 1.3rem; display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem; }
...
export default function StudentDashboard() {
  ...
  const [allJobs, setAllJobs]         = useState([]);            // /api/all-jobs  (CSV feed)
  const [matchedJobs, setMatchedJobs] = useState([]);            // /api/analyze-skills (AI)
  const [vacancies, setVacancies]     = useState([]);            // /api/vacancies
  ...
  // ── Bootstrap: fetch all backend data on mount ────────────────────────────
 useEffect(() => {
  const BASE = 'http://127.0.0.1:5000';

  const bootstrap = async () => {
    // ── FIX: top-level guard so isFeedLoading ALWAYS clears even if an
    //         unexpected exception fires before the inner finally block runs.
    ...
    try {
      ...
      try {
        const res = await axios.get(`${BASE}/api/get-profile`);
        fetchedProfile = res.data;
      } catch (err) {
        console.warn("Profile fetch failed, using mock:", err.message);
        fetchedProfile = {
          id: 1, name: "Default User", username: "default", qualification: "BCA",
          email: "default@test.com", phone: "0000000000", address: "Default City",
          tenth: "Default School", twelfth: "Default School", graduation: "Default College",
          skills: ["Python"], photo: null, certificates: [], personalPosts: [], resumes: [],
          chats: {},
        };
      }
      setProfile(fetchedProfile);

      // 2. Industry Feed – CSV jobs from /api/all-jobs ───────────────────────
      try {
        const res = await axios.get(`${BASE}/api/all-jobs`);
        console.log("Raw jobs response:", res.data);

        // Safely parse — Axios may return a string if Flask sends wrong Content-Type
        let raw = res.data;
        ...
        if (Array.isArray(raw)) {
          ...
          for (const key in raw) {
            if (Array.isArray(raw[key])) { jobsArray = raw[key]; break; }
          }
        }

        console.log("Jobs count:", jobsArray.length, "| First item:", jobsArray[0]);
      ...
      // 3. Other data (parallel) ────────────────────────────────────────────
      const [usersRes, industriesRes, coursesRes, vacanciesRes] = await Promise.allSettled([
        axios.get(`${BASE}/api/users`),
        axios.get(`${BASE}/api/industries`),
        axios.get(`${BASE}/api/courses`),
        axios.get(`${BASE}/api/vacancies`),
      ]);

      setUsers(usersRes.status === 'fulfilled' ? usersRes.value.data : mockUsers);
      setIndustries(industriesRes.status === 'fulfilled' ? industriesRes.value.data : mockIndustries);
      setCourses(coursesRes.status === 'fulfilled' ? coursesRes.value.data : mockCourses);
      setVacancies(vacanciesRes.status === 'fulfilled' ? vacanciesRes.value.data : mockVacancyFeed);

      // 4. AI Skill Matching ─────────────────────────────────────────────────
      if (fetchedProfile?.skills?.length) {
        setIsMatchLoading(true);
        try {
          const res = await axios.post(`${BASE}/api/analyze-skills`, {
      ...
      // Catch-all: prevents spinner from hanging forever on any unhandled throw
      console.error("Bootstrap unexpected error:", unexpectedErr);
    } finally {
      // ── FIX: this ALWAYS runs, even if any block above throws ──
  ...
  const Av = ({ name, photo, size = 48, r = 13 }) =>
    photo
      ...
      : <div className="panel-av" style={{ width: size, height: size, borderRadius: r, fontSize: size * 0.38, flexShrink: 0 }}>
  ...
  const renderPanel = (user, editable = false) => (
    <div style={{ overflowY: "auto", height: "100%" }}>
      ...
      <div className="panel-top">
        ...
        {/* Map through user skills */}
          {user.skills?.map((skill, index) => (
            <span 
              key={index} 
              className="panel-qual-badge" 
              style={{ 
      ...
      {editable && editMode && (
        <>
          ...
          <div className="form-section">
            <div className="form-section-title">Upload Resume (PDF / Image)</div>
            <label className="upload-btn">
              📄 Add Resume / CV
              <input type="file" accept=".pdf,image/*" style={{ display: "none" }}
                onChange={e => {
                  ...
                  setProfile(prev => ({
                    ...prev,
                    resumes: [...prev.resumes, { url, name: file.name, type: file.type, size: (file.size / 1024).toFixed(0) + " KB" }],
                  }));
            ...
            <label className="upload-btn">
              ...
              <input type="file" style={{ display: "none" }}
                onChange={e => {
                  const file = e.target.files[0];
                  if (!file) return;
                  setProfile(prev => ({ ...prev, certificates: [...prev.certificates, { url: URL.createObjectURL(file), type: file.type }] }));
                }} />
            </label>
          </div>
            ...
            <label className="upload-btn">
              ...
              <input type="file" style={{ display: "none" }}
                onChange={e => {
                  const file = e.target.files[0];
                  if (!file) return;
                  setProfile(prev => ({ ...prev, personalPosts: [...prev.personalPosts, { url: URL.createObjectURL(file), type: file.type }] }));
                }} />
            </label>
          </div>
        </>
      ...
      <div className="knowmore-section">
        <button className="knowmore-btn" onClick={() => setShowDetails(d => !d)}>
  ...
  if (!profile) {
    return (
      <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f1f5f9", flexDirection: "column", gap: "1.2rem" }}>
        <style>{CSS}</style>
        <div className="brand" style={{ fontSize: "2rem" }}>Campus2Career</div>
        <div className="spinner" />
        <div style={{ color: "var(--muted)", fontSize: "0.85rem" }}>Fetching your profile…</div>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <nav className="nav">
              ...
              {filteredUsers.length > 0
                ? filteredUsers.map(u => (
                  <div key={u.id} className="search-row"
                    onClick={() => { setActiveUserProfile(u.id); setSearchQuery(""); }}>
        ...
        <div className="nav-right">
          ...
          <div className="notif-btn"
            onClick={() => { setActiveTab("inbox"); setShowProfile(false); setActiveChat(null); }}>
            💬
            {unreadCount > 0 && <div className="notif-dot" />}
          </div>
          <div className="nav-avatar"
            onClick={() => { setShowProfile(s => !s); setActiveChat(null); }}
            title={profile.name}>
            {profile.photo
              ? <img src={profile.photo} style={{ width: 36, height: 36, objectFit: "cover" }} alt="" />
      ...
      <div className="layout">
        ...
        {/* ── LEFT: Other student profile ── */}
        <AnimatePresence>
          {activeUserProfile && (() => {
            const user = users.find(u => u.id === activeUserProfile);
            return user ? (
        ...
        <main className="content">
          ...
          {/* FEED TAB — CSV jobs from /api/all-jobs */}
          {activeTab === "feed" && (
              ...
              <div className="page-section">
                <div className="sec-head">
                  <div>
                    ...
                    <span className="sec-sub">Live Naukri Vacancies</span>
                  </div>
                  {!isFeedLoading && (
                ...
                {isFeedLoading ? (
                  ...
                  <div className="feed-grid">
                    {allJobs.map((item, index) => {
                      const jobTitle  = item.job      || "Untitled Position";
                      const industry  = item.industry || "Unknown Company";
                      ...
                      // ── FIX: hide the scraper sentinel string in the card ──
                      const SENTINEL = "Contact employer for details.";
                      const rawDesc  = item.desc || "";
                      const description = (
                        !rawDesc ||
                        rawDesc === "Description block not found or inaccessible" ||
                        rawDesc === "Contact for details"
                      ) ? SENTINEL : rawDesc;

                      return (
                        <div key={index} className="feed-card" style={{ borderLeft: "4px solid var(--indigo)" }}>
                          <div className="feed-body">
                            <div className="feed-owner-row">
                              <div className="feed-owner-left">
                                <div className="feed-logo">
                                  {industry.substring(0, 2).toUpperCase()}
                                </div>
                                <div>
                                  <div className="feed-owner-name">{industry}</div>
                                  <div className="feed-date">{department}</div>
                                </div>
                              </div>
                              <span className="type-chip chip-job">Job Vacancy</span>
                            </div>
                            ...
                            {role && (
                              <div style={{ fontSize: "0.8rem", color: "var(--emerald)", marginBottom: "6px", fontWeight: 600 }}>
                                Role: {role}
                              </div>
                            )}

                            {/* ── FIX: show education eligibility (UG / PG) ── */}
                            {(ug || pg) && (
                              <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", marginBottom: "8px" }}>
                                {ug && (
                                  <span style={{ fontSize: "0.72rem", background: "rgba(79,70,229,0.08)", color: "var(--indigo)", border: "1px solid rgba(79,70,229,0.18)", borderRadius: 99, padding: "0.15rem 0.6rem", fontWeight: 600 }}>
                                    UG: {ug}
                                  </span>
                                )}
                                {pg && pg !== "Not Required" && (
                                  <span style={{ fontSize: "0.72rem", background: "rgba(16,185,129,0.08)", color: "var(--emerald)", border: "1px solid rgba(16,185,129,0.18)", borderRadius: 99, padding: "0.15rem 0.6rem", fontWeight: 600 }}>
                                    PG: {pg}
                                  </span>
                                )}
                              </div>
                            ...
                            <p style={{
                              ...
                              overflow: "hidden",
                              fontStyle: description === SENTINEL ? "italic" : "normal",
                            }}>
                              {description}
                            </p>

                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "0.5rem" }}>
                              <div style={{ fontSize: "0.76rem", color: "var(--muted)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                {skills
                                  ? `🛠 ${skills.substring(0, 55)}${skills.length > 55 ? "…" : ""}`
                                  : "Skills not listed"}
                              </div>
                              <a
                                href={link}
                  ...
                  <div className="no-courses">
                    No jobs found from backend.<br />
                    Make sure Flask server is running and <strong>/api/all-jobs</strong> returns an array.
                  </div>
                )}
              </div>
            </motion.div>
          ...
          {/* JOBS TAB — AI matched jobs from /api/analyze-skills */}
          {activeTab === "jobs" && (
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
              <div className="page-section">
                <div className="sec-head">
                  <div>
                    <span className="sec-title">Recommended Jobs</span>
                    <span className="sec-sub">AI-matched to your skills</span>
                  </div>
                </div>
                ...
                {isMatchLoading ? (
                  <div className="loading-spinner">
                    <div className="spinner" />
                    <span>Analysing your skills with AI…</span>
                  </div>
                ) : matchedJobs.length === 0 ? (
                  <div className="no-courses">
                    No AI matches yet. Make sure your skills are set in your profile and the Flask server is running.
                  </div>
                ) : (
                  <div className="jobs-grid">
                    {matchedJobs.map((job, i) => (
                      <motion.div key={i} className="job-card" whileHover={{ y: -5 }}>
                        <img className="job-img"
                          src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400"
                          alt="" />
                        <div className="job-body">
                          <div className="job-company">{job.industry}</div>
                          <div className="job-title-text">{job.job}</div>
                          <div className="job-tags">
                            <span className="badge" style={{ background: "rgba(34,197,94,0.1)", color: "#15803d", borderColor: "rgba(34,197,94,0.2)" }}>
                              {job.match_confidence}% Match
                            </span>
                            {job.missing_skills?.length > 0 && (
                              <span className="badge" style={{ background: "rgba(239,68,68,0.1)", color: "#b91c1c", borderColor: "rgba(239,68,68,0.2)" }}>
                                Missing: {job.missing_skills[0]}
                              </span>
                            )}
                          </div>
                          <div className="job-salary">Salary: Negotiable</div>
...
{activeTab === "courses" && (
  <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
    <div className="page-section">
      <div className="sec-head">
        <div>
          <span className="sec-title">Skill-Based Recommendations</span>
          <span className="sec-sub">Tailored for your {profile?.qualification} background</span>
        </div>
        <button className="sec-link">Explore All Courses →</button>
      </div>

      {/* Check if courses were loaded from the backend */}
      {Array.isArray(courses) && courses.length > 0 ? (
        <div className="courses-grid">
          {courses
            .filter(course => !profile?.qualification || course.field === profile.qualification)
            .map(course => {
              // Ensure level style exists, fallback to Beginner if CSV has a typo
                ...
                >
                  <div className="course-img-wrap">
                    <img 
                      ...
                      alt={course.title} 
                    />
                    <span className="level-chip" style={{ background: lv.bg, color: lv.color, borderColor: lv.border }}>
                      {course.level}
                    </span>
                  </div>
                  ...
                  <div className="course-body">
                    ...
                    <div className="course-name" style={{ marginBottom: '8px', minHeight: '40px' }}>{course.title}</div>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px', marginBottom: '12px' }}>
                      {Array.isArray(course.skills) ? (
                        ...
                        <span style={{ fontSize: '0.62rem', color: 'var(--subtle)' }}>General Skillset</span>
                      )}
                    </div>
                    ...
                    <div className="course-ft" style={{ marginTop: '12px' }}>
                      <div className="rating">
                        <span>★</span>{course.rating || "4.5"}
                      </div>
                      <button className="enroll-btn" onClick={() => pushNotify(`Redirecting to ${course.provider}...`)}>
                        Enroll Now
                      </button>
                    </div>
                  </div>
        ...
        <div className="no-courses">
          ...
          No courses found for your profile qualification.<br />
          <small style={{ color: 'var(--subtle)' }}>Ensure your courses.csv 'field' column matches your profile.</small>
        </div>
      )}
    </div>
  </motion.div>
              ...
              <div className="page-section">
                <div className="sec-head">
                  <div>
                    ...
                    <span className="sec-sub">{myApplications.length} total</span>
                  </div>
                </div>
                      ...
                      <div key={app.id} className="app-card">
                        ...
                        {app.status === "Shortlisted" && (
                          <div style={{ marginTop: "0.75rem", background: "rgba(79,70,229,0.06)", border: "1px solid rgba(79,70,229,0.15)", borderRadius: 10, padding: "0.7rem 0.9rem", fontSize: "0.8rem", color: "var(--indigo)", fontWeight: 600 }}>
                            🎉 You've been shortlisted! The company may reach out via messages.
                          </div>
                        )}
                        {app.status === "Selected" && (
          ...
          {activeTab === "inbox" && (
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
              <div className="page-section">
                <div className="sec-head">
                  <div>
                    <span className="sec-title">Messages from Companies</span>
                    <span className="sec-sub">{unreadCount} unread</span>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.9rem" }}>
                  {inboxMessages.map(msg => (
                    <div key={msg.id}
                      style={{
                        background: msg.read ? "rgba(255,255,255,0.7)" : "rgba(79,70,229,0.05)",
                        border: `1px solid ${msg.read ? "var(--border)" : "rgba(79,70,229,0.2)"}`,
                        borderRadius: 16, padding: "1.1rem 1.3rem", cursor: "pointer",
                        display: "flex", gap: "1rem", alignItems: "flex-start", transition: "0.2s",
                      }}
                      onClick={() => {
                        setActiveChat(msg.fromId);
                        setInboxMessages(prev => prev.map(m => m.id === msg.id ? { ...m, read: true } : m));
                      }}>
                      <div style={{ width: 42, height: 42, borderRadius: 11, background: "var(--grad)", color: "white", fontFamily: "Syne, sans-serif", fontWeight: 800, fontSize: "0.9rem", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        {msg.fromLogo}
                      </div>
                      <div style={{ flex: 1 }}>
              ...
              <div className="dm-head">
                <div>
                  <div className="dm-recipient">
                    {industries.find(i => i.id === activeChat)?.name ?? "Company"}
                  </div>
                  <div className="dm-status">
                    <span className="online-dot" />Company · Active
                  </div>
                </div>
          ...
          <motion.div className="modal-overlay"
            ...
            <motion.div className="modal-box"
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.85rem", marginBottom: "1.5rem" }}>
                <div style={{ width: 50, height: 50, borderRadius: 13, background: "rgba(79,70,229,0.1)", color: "var(--indigo)", fontFamily: "Syne, sans-serif", fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  {postDetailModal.ownerLogo}
                </div>
                <div>
                  <div className="modal-title" style={{ fontSize: "1.4rem" }}>{postDetailModal.title}</div>
                  <div style={{ color: "var(--indigo)", fontWeight: 700, fontSize: "0.85rem" }}>
                    {postDetailModal.ownerName} · {postDetailModal.type}
                  </div>
                </div>
              </div>
              <div style={{ marginBottom: "1.2rem", lineHeight: 1.6, color: "var(--muted)", fontSize: "0.9rem" }}>{postDetailModal.desc}</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.8rem", marginBottom: "1.2rem" }}>
                <div><strong>Duration:</strong> {postDetailModal.duration}</div>
                <div><strong>Skills:</strong> {postDetailModal.skills}</div>
                <div style={{ gridColumn: "1 / -1" }}><strong>Offerings:</strong> {postDetailModal.offerings}</div>
              </div>
              {postDetailModal.type !== "Update" && (
                alreadyApplied(postDetailModal.id)
                  ? <div style={{ textAlign: "center", padding: "0.9rem", background: "#dcfce7", borderRadius: 12, color: "#166534", fontWeight: 700 }}>
                      ✓ You've already applied to this position
                    </div>
                  : <button className="btn-primary" onClick={() => { setApplyModal(postDetailModal); setPostDetailModal(null); }}>
                      Apply for this Role
                    </button>
              )}
            </motion.div>
